...
class GaussianDataset(Dataset):
    def __init__(self, root_dir_images, root_dir_labels, apply_constant_blur=True):
        ...
        self.apply_constant_blur = apply_constant_blur
    ...
    def __getitem__(self, index):
        ...
        if self.apply_constant_blur:
            image = transforms.functional.gaussian_blur(image, kernel_size=15, sigma=(5,5))
        else:
            # apply variable blur
            pass
